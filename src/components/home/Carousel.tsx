...
const HeroSection: React.FC<HeroSectionProps> = ({ heroData, heroStats }) => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative min-h-screen bg-gradient-to-br from-slate-900 via-blue-900/50 to-slate-900 overflow-hidden"
    >
          ...
          >
            ...
            >
              ...
              >
                ...
                />
                <span>{heroData?.ctaText2 || "Watch Demo"}</span>
              </Link>
            </motion.div>
            ...
            >
              {heroStats && heroStats.length > 0 ? (
                heroStats.slice(0, 8).map((stat, index) => (
