...
import { useServiceCategories, useServices } from "@/hooks/useContent";
...
const ServiceDetail = () => {
  ...
  useEffect(() => {
    if (servicesData?.data && categoriesData?.data && serviceId) {
      const foundService = servicesData.data.find(
        (s: any) =>
          s.id === Number(serviceId) || s.link.split("/").pop() === serviceId
      );
      if (foundService) {
        setService(foundService);
        const foundCategory = categoriesData.data.find(
          (c: any) => c.id === foundService.categoryId
        );
    ...
    //   }
    // }
  }, [serviceId, servicesData, categoriesData]);
  ...
  return (
    <>
      <Helmet>
        <title>
          {service.title} | Digihub - {category.title}
        </title>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">
                        Our experienced professionals deliver high-quality
                        solutions.
                      </p>
                    </div>
                  </li>
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">
                        We have a history of successful projects and satisfied
                        clients.
                      </p>
                    </div>
                  </li>
          ...
          <div className="container">
            ...
            >
              ...
              <p className="text-gray-300 max-w-2xl mx-auto">
                We follow a systematic approach to deliver high-quality
          ...
          <div className="container">
            ...
            >
              ...
              <p className="text-gray-300 mb-8">
                ...
                help your business grow and succeed. Contact us today for a free
                consultation.
              </p>
              <Link
                to="/contact"
