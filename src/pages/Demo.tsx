...
const getYouTubeId = (url: string) => {
  try {
    // Matches ?v=VIDEOID or /embed/VIDEOID
...
const Demo = () => {
  const { data, isLoading, isError } = useDemoVideos();
  ...
  const videos = data?.data.filter((video: any) => video.isActive) || [];

  const handleVideoClick = (videUrl?: string) => {
    // Open YouTube video in new tab
    if (!videUrl) {
      return;
    }
    window.open(encodeURI(videUrl), "_blank");
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Watch live demonstrations of our innovative digital solutions. See how our products transform business operations and enhance user experiences."
        />
      </Helmet>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <p className="text-xl text-gray-200 leading-relaxed text-justify">
                  Experience our innovative solutions in action. Watch detailed
                  demonstrations of our products and see how they can transform
          ...
          <div className="container relative z-10">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto text-justify">
                ...
                Our comprehensive demos showcase the power and flexibility of
                our solutions.
              </p>
            </motion.div>
          ...
          <div className="container mx-auto text-center relative z-10">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 text-justify max-w-3xl mx-auto">
                Interested in a personalized demo or have questions about our
                solutions? Let's discuss how we can help transform your
                business.
              </p>
              <motion.div
